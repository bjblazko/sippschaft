...
- **Style** (`data-theme-style`): `classic` or `modern` -- controls font, accent colors, border radius, and overall visual feel.
...
- Four theme variants (classic-light, classic-dark, modern-light, modern-dark) from a single stylesheet.
